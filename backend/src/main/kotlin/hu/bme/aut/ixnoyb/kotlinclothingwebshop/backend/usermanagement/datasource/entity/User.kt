...
import hu.bme.aut.ixnoyb.kotlinclothingwebshop.backend.usermanagement.service.UserCandidate as DomainUserCandidate
...
data class User(
    ...
    val lastName: String,
    val dateOfBirth: LocalDate, // TODO kotlinx-datetime doesn't work, but it should
...
fun UpdatableUserCandidate.toUser(storedPassword: String?): User = User(
    id = id.value,
    username = user.username.value,
    email = user.email.value,
    password = storedPassword ?: "",
